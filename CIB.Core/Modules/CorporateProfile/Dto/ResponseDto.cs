...
namespace CIB.Core.Modules.CorporateProfile.Dto
{
	...
	public class CorporateProfileDto : BaseUpdateDto
	{
	...
	public class RequestCorporateProfileDto : BaseUpdateDto
	{
		public Guid Id { get; set; }
		public string Reason { get; set; }
	...
	public class UpdateProfileRoleDto : BaseUpdateDto
	{
		public string Id { get; set; }
		public string RoleId { get; set; }
	}
	public class ChangeProfileStatusDto : BaseUpdateDto
	{
		public string Id { get; set; }
		public string Reason { get; set; }
	}
