...
namespace CIB.Core.Modules.Transaction
{
	public interface ITransactionRepository : IRepository<TblTransaction>
	{
		...
		IEnumerable<TransactionReportDto> Search(Guid? corporateCustomerId, string transactionRef, DateTime dateFrom, DateTime dateTo, bool IsBulk, int pageNumber, int pageSize);
