...
namespace CIB.Core.Utils
{
	public static class Encryption
	{
		...
		public static string DecriptPin(string pin)
		{
			return OpenSSLDecrypt(pin, PinEncrptionKey());
		}
		...
		public static string EncryptPin(string data)
		{
			return OpenSSLEncrypt(data, PinEncrptionKey());
		}
		...
		private static string PinEncrptionKey()
		{
			return "#!$50P1ns";
		}
	}
