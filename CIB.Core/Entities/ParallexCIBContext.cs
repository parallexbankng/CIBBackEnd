...
namespace CIB.Core.Entities
{
	public partial class ParallexCIBContext : DbContext
	{
		...
		public virtual DbSet<TblCorporateAccountAggregation> TblCorporateAccountAggregations { get; set; }
		public virtual DbSet<TblAggregatedAccount> TblAggregatedAccounts { get; set; }
		public virtual DbSet<TblTempAggregatedAccount> TblTempAggregatedAccounts { get; set; }
		public virtual DbSet<TblTempCorporateAccountAggregation> TblTempCorporateAccountAggregations { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<TblAggregatedAccount>(entity =>
			{
				entity.Property(e => e.Id).ValueGeneratedNever();
				entity.Property(e => e.Sn).ValueGeneratedOnAdd();
			});
			modelBuilder.Entity<TblCorporateAccountAggregation>(entity =>
			{
				entity.Property(e => e.Id).ValueGeneratedNever();
				entity.Property(e => e.Sn).ValueGeneratedOnAdd();
			});
			modelBuilder.Entity<TblTempAggregatedAccount>(entity =>
			{
				entity.Property(e => e.Id).ValueGeneratedNever();
				entity.Property(e => e.Sn).ValueGeneratedOnAdd();
			});
			modelBuilder.Entity<TblTempCorporateAccountAggregation>(entity =>
			{
				entity.Property(e => e.Id).ValueGeneratedNever();
				entity.Property(e => e.Sn).ValueGeneratedOnAdd();
			});
