...
namespace CIB.Core.Entities
{
    public partial class ParallexCIBContext : DbContext
    {
        ...
        public virtual DbSet<TblTempChequeRequet> TblTempChequeRequets { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=tcp:10.120.0.57,1433; Initial Catalog =ParallexCIB; User ID =sa; Password =tATZz%5#TwtATZz%5#Tw; Connection Timeout = 30; ");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblTempChequeRequet>(entity =>
            {
                entity.Property(e => e.Id).ValueGeneratedNever();
