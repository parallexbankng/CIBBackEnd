...
namespace CIB.Core.Entities
{
	public partial class TblCorporateProfile
	{
		...
		public int? HasCheckPolicyAgreement { get; set; }
		public int? ResetPinInitiated { get; set; }
		public DateTime? DateResetPinInitiated { get; set; }
		public string? DefaultTranPin { get; set; }
	}
}
