...
namespace CIB.Core.Services.OnlendingApi.Dto
{
    public class OnlendingServiceApi : IOnlendingServiceApi
    {
        ...
        public async Task<OnlendingAccountOpeningResponse> AccountOpening(OnlendingBeneficiaryAccountOpeningRequest request)
        {
            ...
            var url = _config.GetValue<string>("TestApiUrl:accountOpening");
        ...
        public async Task<OnleandingResponse> CalculateIntrest(OnlendingGetInterestRequest request)
        {
            var _httpClient = httpClient.CreateClient("tokenClient");
            var authResult = await GetAuthToken();
            _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", authResult.Token);
            var url = _config.GetValue<string>("TestApiUrl:getInterest");
            var data = JsonConvert.SerializeObject(request);
            var payLoad = new StringContent(data, Encoding.UTF8, "application/json");
            try
            {
        ...
        public async Task<OnleandingResponse> InitiateBeneficiaryDisbursment(OnlendingInitiateBeneficiaryDisburstment request)
        {
            var _httpClient = httpClient.CreateClient("tokenClient");
            var authResult = await GetAuthToken();
            _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", authResult.Token);
        ...
        public async Task<OnlendingLiquidationResponse> LiquidatePayment(OnlendingFullLiquidationRequest request)
        {
            ...
            var authResult = await GetAuthToken();
            _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", authResult.Token);
            var url = _config.GetValue<string>("TestApiUrl:preLiquidation");
            var data = JsonConvert.SerializeObject(request);
            var payLoad = new StringContent(data, Encoding.UTF8, "application/json");
            try
            {
        ...
        {
            var _httpClient = httpClient.CreateClient("tokenClient");
            var url = _config.GetValue<string>("TestApiUrl:validateBvn");
        ...
        {
            var _httpClient = httpClient.CreateClient("tokenClient");
            var url = _config.GetValue<string>("TestApiUrl:validateNin");
        ...
        {
            var _httpClient = httpClient.CreateClient("tokenClient");
            var url = _config.GetValue<string>("TestApiUrl:validatePassport");
        ...
        public async Task<OnlendingMerchantBeneficiaryResponse> GetMerchantBeneficairies(string merchantAccountNumber)
        {
            var _httpClient = httpClient.CreateClient("tokenClient");
            var authResult = await GetAuthToken();
            _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", authResult.Token);
            var url = _config.GetValue<string>("TestApiUrl:getMerchantBeneficairies");
            try
            {
