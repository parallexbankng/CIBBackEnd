...
namespace CIB.Core.Templates
{
	public static class EmailTemplate
	{
		...
		public static EmailRequestDto Transfer(string receiverEmail, EmailNotification profile, string amount)
		{
			...
			{
				body = $"<p> A fund transfer of {profile.Amount} initiated by {profile.FullName} has been decline<br /> </p>" +
							$"<p> Reason {profile.Reason} </p>";
			}

			if (profile.Action == nameof(AuthorizationStatus.Approved))
			{
				body = $"<p> A fund transfer of {profile.Amount} initiated by {profile.FullName} requires your approval, please login to the parallex bank corporate internet banking to approve.<br /> </p>";
			}
		...
		public static EmailRequestDto LoginMail(string receiverEmail, string fullName, string filePath)
		{
			...
			body = body.Replace("[Name]", textinfo.ToTitleCase(fullName.ToLower()));
		...
		public static EmailRequestDto NewUserNameMail(string receiverEmail, string fullName, string UserName, string filePath)
		{
			string body = string.Empty;
			using (StreamReader reader = new(filePath))
			{
			...
			var textinfo = new CultureInfo("en-US", false).TextInfo;
			body = body.Replace("[Name]", textinfo.ToTitleCase(fullName.ToLower()));
			body = body.Replace("[UserName]", textinfo.ToTitleCase(UserName.ToLower()));
			var template = new EmailRequestDto
			{
				subject = $"Parallexbank Corporate profile UserName Change  Notification",
				message = body,
				recipient = receiverEmail,
				sender = "no-reply@parallexbank.com"
			};
		...
		public static EmailRequestDto ResetPinCredentialMail(string receiverEmail, string fullName, string defaultPin, string filePath)
		{
			string body = string.Empty;
			using (StreamReader reader = new(filePath))
			{
			...
			var textinfo = new CultureInfo("en-US", false).TextInfo;
			body = body.Replace("[CustomerName]", textinfo.ToTitleCase(fullName.ToLower()));
			body = body.Replace("[DefaultPin]", defaultPin);
			var template = new EmailRequestDto
			{
				subject = $"Pin Reset",
				message = body,
		...
		public static EmailRequestDto ResetPasswordCredentialMail(string receiverEmail, string fullName, string password, string filePath)
		{
			string body = string.Empty;
			using (StreamReader reader = new(filePath))
			{
			...
			var template = new EmailRequestDto
			{
				subject = $"Password Reset parallexbank Corporate Banking",
				message = body,
				recipient = receiverEmail,
				sender = "no-reply@parallexbank.com"
			};
		...
		public static EmailRequestDto UserOnboardingMailWithCredentialMail(string receiverEmail, string fullName, string userName, string password, string filePath)
		{
			string body = string.Empty;
			using (StreamReader reader = new(filePath))
			{
			...
			var template = new EmailRequestDto
			{
				subject = $"Welcome to parallexbank Corporate Banking",
				message = body,
				recipient = receiverEmail,
				sender = "no-reply@parallexbank.com"
			};
		...
		public static EmailRequestDto ResendCustomerUserNameMail(string receiverEmail, string fullName, string userName, string filePath)
		{
			string body = string.Empty;
			using (StreamReader reader = new(filePath))
			{
			...
			var textinfo = new CultureInfo("en-US", false).TextInfo;
			body = body.Replace("[CustomerName]", textinfo.ToTitleCase(fullName.ToLower()));
			body = body.Replace("[UserName]", textinfo.ToTitleCase(userName));
			var template = new EmailRequestDto
			{
				subject = $"New UserName parallexbank Corporate Banking",
				message = body,
				recipient = receiverEmail,
				sender = "no-reply@parallexbank.com"
			};
