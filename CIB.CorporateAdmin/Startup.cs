...
namespace CIB.CorporateAdmin
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddCors(c => c.AddPolicy(Cors, cors => cors.WithOrigins("https://icorporate.parallexbank.com", "https://www.icorporate.parallexbank.com", "www.icorporate.parallexbank.com", "icorporate.parallexbank.com").AllowAnyHeader().AllowAnyMethod()));
