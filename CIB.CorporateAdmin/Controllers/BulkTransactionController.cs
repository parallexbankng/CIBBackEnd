  ...
  public class BulkTransactionController : BaseAPIController
  {
    ...
    public async Task<ActionResult<ResponseDTO<VerifyBulkTransactionResponse>>> VerifyBulkTransfer([FromForm] VerifyBulkTransactionDto model)
    {
      try
      {
        ...
        if (dtb.Count == 0)
        {
          LogFormater<BulkTransactionController>.Error(_logger, "VerifyBulkTransfer", "No Data in Excel File To Read", JsonConvert.SerializeObject(corporateCustomer.CustomerId));
        ...
        {
          var message = "can not verify Source Account Number";
          LogFormater<BulkTransactionController>.Error(_logger, "VerifyBulkTransfer", message, JsonConvert.SerializeObject(corporateCustomer.CustomerId));
          return BadRequest(message);
        }
        ...
        {
          LogFormater<BulkTransactionController>.Error(_logger, "VerifyBulkTransfer", errorMessage, JsonConvert.SerializeObject(corporateCustomer.CustomerId));
        ...
        if (Enum.TryParse(corporateCustomer.AuthorizationType.Replace(" ", "_"), out AuthorizationType _auth))
        {
          if (_auth != AuthorizationType.Single_Signatory)
          {
            ...
            {
              LogFormater<BulkTransactionController>.Error(_logger, "VerifyBulkTransfer", workflowStatus.Message, JsonConvert.SerializeObject(corporateCustomer.CustomerId));
    ...
    public async Task<ActionResult<bool>> InitiateBulkTransfer([FromForm] InitiateBulkTransactionDto model)
    {
      try
      {
        ...
        if (totalDebitProcessAmount <= 0)
        {
          ...
          LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", "invalid Debit Amount", JsonConvert.SerializeObject(userName), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
        ...
        if (Enum.TryParse(tblCorporateCustomer.AuthorizationType.Replace(" ", "_"), out AuthorizationType _auth))
        {
          if (_auth != AuthorizationType.Single_Signatory)
          {
            ...
            {
              _fileService.DeleteFile(filePath);
              LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", validateWorkFlow.Message, JsonConvert.SerializeObject(userName), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
        ...
        {
          _fileService.DeleteFile(filePath);
          LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", "Authorization type could not be determined!!!", JsonConvert.SerializeObject(userName), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
          return BadRequest("Authorization type could not be determined!!!");
        }
        ...
        if (corporateAccount.RespondCode != "00")
        {
          LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", "could not verify Source Account Number", JsonConvert.SerializeObject(corporateAccount), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
        ...
        if (tblCorporateCustomer.MaxAccountLimit < totalDebitProcessAmount)
        {
          ...
          LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", message, JsonConvert.SerializeObject(corporateAccount), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
          return BadRequest(message);
        }
        var senderInfo = await _apiService.CustomerNameInquiry(payload.SourceAccountNumber);
        if (senderInfo.ResponseCode != "00")
        ...
        {
          LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", errorMsg, JsonConvert.SerializeObject(senderInfo), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
        ...
        if (_auth == AuthorizationType.Single_Signatory)
        {
          ...
          {
            _fileService.DeleteFile(filePath);
            LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", "Insufficient funds", JsonConvert.SerializeObject(corporateAccount), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
            return BadRequest("Insufficient funds");
          }

          if (bulkSuspenseCreditItems.Count > 2)
          {
            LogFormater<BulkTransactionController>.Error(_logger, "InitiateBulkTransfer", "The transaction is not balanced.", JsonConvert.SerializeObject(bulkSuspenseCreditItems), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
