  ...
  public class TransactionController : BaseAPIController
  {
    ...
    public async Task<ActionResult<List<BankAccountModel>>> GetCorporateAccounts(string corporateCustomerId)
    {
      try
      {
        ...
        {
          LogFormater<TransactionController>.Error(_logger, "Get Corporate Accounts", dto.RespondMessage, JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId), "");
    ...
    public async Task<ActionResult<bool>> VerifyIntraBankTransaction(IntraBankTransactionDto model)
    {
      try
      {
        ...
        {
          payload.Otp = "";
          LogFormater<TransactionController>.Error(_logger, "VerifyIntraBankTransaction", "could not verify Source Account Number", JsonConvert.SerializeObject(payload), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
        ...
        {
          payload.Otp = "";
          _logger.LogError("Payload Change ERROR {0}, {1}", Formater.JsonType("Source Account Number Has been manipulated"), Formater.JsonType(payload), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
    ...
    public async Task<ActionResult<bool>> InitiateIntraBankTransaction(IntraBankTransactionDto model)
    {
      ...
      try
      {
        ...
        {
          payload.TransactionLocation = ""; payload.Otp = "";
          var errorMessage = $"could not verify Source Account Number -> {corporateAccount.RespondMessage}";
          LogFormater<TransactionController>.Error(_logger, "InitiateIntraBankTransaction", errorMessage, JsonConvert.SerializeObject(corporateAccount), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
          return BadRequest(errorMessage);
        }
    ...
    public async Task<ActionResult<bool>> VerifyInterBankTransaction(InterBankTransactionDto model)
    {
      try
      {
        ...
        {
          payload.Otp = ""; payload.TransactionLocation = "";
          LogFormater<TransactionController>.Error(_logger, "VerifyInterBankTransaction", "could not verify Source Account Number", JsonConvert.SerializeObject(payload), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
          return BadRequest("could not verify Source Account Number");
        }
    ...
    public async Task<ActionResult<bool>> InitiateInterBankTransaction(IntraBankTransactionDto model)
    {
      try
      {
        ...
        {
          payload.Otp = "";
          LogFormater<TransactionController>.Error(_logger, "InitiateInterBankTransaction", "could not verify Source Account Number", JsonConvert.SerializeObject(payload), JsonConvert.SerializeObject(tblCorporateCustomer.CustomerId));
          return BadRequest("could not verify Source Account Number");
        }
        ...
        var pendingCreditLog = new TblPendingCreditLog();
        var corporateApprovalHistoryList = new List<TblCorporateApprovalHistory>();
        var transactionReference = new GenerateBulkTransactionRefrences().Create16DigitString();
        var batchid = Guid.NewGuid();
    ...
    public async Task<ActionResult<bool>> ApproveTransaction(ApproveTransactionDto model)
    {
      try
      {
        ...
        if (pendingTranLog.ApprovalCount == pendingTranLog.ApprovalStage)
        {
          ...
          {
            var resultt = await PostIntraBankTransfer(tblPendingCreditLog, pendingTranLog, date, auditTrail);
            ...
            pendingCreditLog.TransactionReference = pendingTranLog.TransactionReference;
            pendingCreditLog.SessionId = resultt.TransactionReference;
            pendingTranLog.SessionId = resultt.TransactionReference;
          ...
          var result = await PostInterBankTransfer(tblPendingCreditLog, pendingTranLog, date, auditTrail);
          if (result.ResponseCode != "00")
          {
    ...
    private async Task<IntraBankTransferResponse> PostIntraBankTransfer(TblPendingCreditLog pendingCreditLog, TblPendingTranLog pendingTranLog, DateTime date, TblAuditTrail trail)
    {
      var transfer = new IntraBankPostDto
      {
    ...
    protected async Task<IntraBankTransferResponse> PostInterBankTransfer(TblPendingCreditLog pendingCreditLog, TblPendingTranLog pendingTranLog, DateTime date, TblAuditTrail trail)
    {
      var transfer = new InterBankPostDto
      {
        accountToDebit = pendingTranLog.DebitAccountNumber,
