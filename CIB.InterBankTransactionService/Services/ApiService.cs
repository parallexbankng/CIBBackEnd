...
public class ApiService : IApiService
{
  ...
  public async Task<RequeryTransactionResponse> QueryTransferTransaction(RequeryTransaction query)
  {
    ...
    var url = _config.GetValue<string>("prodApiUrl:queryTransaction");
    ...
    catch (Exception ex)
    {
      ...
      _logger.LogError("QueryTransferTransaction API ERROR {0}", JsonConvert.SerializeObject(errorItem));
      return errorItem;
    }
  }
